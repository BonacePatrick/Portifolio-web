  ...
  return (
    ...
    <div className="navbar bg-white">
        <div className="navbar-start">
            ...
            <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3  shadow bg-[#333333] rounded-box w-14  lg:h-56 relative ">
                ...
                <li className='ml-6 hover:text-[#daa320]'><i className="fa-solid fa-briefcase lg:-translate-x-4 lg:-translate-y-5 lg:mb-3 hover:text-[#daa320] text-[#daa320] font-extrabold -translate-x-5 -translate-y-12 text-xs lg:text-sm"></i><Link to='/Portfolio' className='-translate-y-[4.8rem] lg:-translate-y-16 translate-x-5 text-xs lg:text-sm text-[#daa320]'>PORTFOLIO</Link></li>
