    ...
    <>
     <div className="navbar bg-[#162124]">
        <div className="navbar-start">
            ...
            <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3  shadow bg-[#333333] rounded-box w-14  lg:h-56 relative text-white">
                <li className='ml-6 hover:text-[#daa320]'><i className="fa-solid fa-house lg:-translate-x-4 lg:translate-y-8 hover:text-[#daa320]  font-extrabold -translate-x-5 translate-y-3 text-xs lg:text-sm"></i><Link to='/' className='translate-x-5 -translate-y-4 lg:translate-y-0 text-xs lg:text-sm '>HOME</Link></li>
                <li className='ml-6 hover:text-[#daa320]'><i className="fa-solid fa-user lg:-translate-x-4 lg:translate-y-1 lg:my-3 hover:text-[#daa320]  font-extrabold -translate-x-5 -translate-y-4 text-xs lg:text-sm"></i><Link to='/About' className='-translate-y-[2.2rem] lg:-translate-y-10 translate-x-5 text-xs lg:text-sm'>ABOUT</Link></li>
                <li className='ml-6 hover:text-[#daa320]'><i className="fa-solid fa-briefcase lg:-translate-x-4 lg:-translate-y-5 lg:mb-3 hover:text-[#daa320] font-extrabold -translate-x-5 -translate-y-12 text-xs lg:text-sm"></i><Link to='/Portfolio' className='-translate-y-[3.3rem] lg:-translate-y-16 translate-x-5 text-xs lg:text-sm'>PORTFOLIO</Link></li>
                ...
                <li className='ml-6 hover:text-[#daa320] absolute top-[7.5rem] lg:top-64'><i className="fa-solid fa-envelope lg:-translate-x-4 lg:-translate-y-16 hover:text-[#daa320] font-extrabold  -translate-x-5 text-xs lg:text-sm"></i><Link to='/Blog' className='lg:translate-x-5 lg:-translate-y-24 -translate-y-6 translate-x-5 text-xs lg:text-sm'>BLOG</Link></li>
            </ul>
            </div>
        </div>
   </div>
