  ...
  <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900">
    <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        <header className="mb-4 lg:mb-6 not-format">
          <address className="flex items-center mb-6 not-italic">
            <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
              <img className="mr-4 w-16 h-16 rounded-full object-cover " src="./assets/Bonace.jpg" alt="Bonace Patrick" />
              <div>
                <a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">Bonace Patrick</a>
                <p className="text-base font-light text-gray-500 dark:text-gray-400">Professional Web developer, &amp; creativity </p>
          ...
          <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Create Website With HTML CSS JS</h1>
        </header>
        <p className="lead text-lg mb-4">You’re in the right place. In this guide, we show you all the steps
         to get from a blank screen to a working website that’s optimized 
         and quite good-looking at the same time.
        </p>
        <p className='text-lg mb-4'>But first, what is HTML and CSS? <br />.
        Well, you could just look up both terms in Wikipedia, but those definitions
         aren’t very reader-friendly. Let’s simplify things a bit:
        </p>
        <p>

        </p>
        <figure><img className='rounded-xl' src="https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/152655711/original/909c3cab9b1ef397e8e8dac977b51ac3bb8d0d4e/build-your-responsive-website-using-html-css-js-and-php.png" alt />
          <figcaption className='font-semibold text-lg my-4'>Introduction</figcaption>
        </figure>
        <h2 className='font-semibold text-xl my-3'>But first, what is HTML and CSS?</h2>
        ...
        <p className='text-lg mb-4'>
            You can’t really have one without the other – the two work together to make up 
            the final web page, its design, and the content that’s on it.
        </p>
        <p className='text-lg mb-4'>
        Note; when we say “a web page,” what we mean is a single HTML document – a single page 
        that’s part of your website. Whereas, “a website” is the complete thing – your whole site with all its individual web pages.

        </p>

        <h2 className='font-semibold text-3xl'>Before You Start, Gather Your Resources</h2>
        <p className='text-lg my-4'>While it might seem like extra work at a first glance, here are some key moments in which prototyping
          will come in handy:
        </p>
        <ol>
          <li className='text-lg my-4'><strong className='text-lg'>Usability testing</strong>. Does your user know how to exit out of screens? Can they
          ...
          <li className='text-lg my-4'><strong className='text-lg'>Involving stakeholders</strong>. Need to check if your GDPR consent boxes are displaying
            properly? Pass your prototype to your data protection team and they can test it for real;</li>
          <li className='text-lg mb-4'><strong className='text-lg'>Impressing a client</strong>. Prototypes can help explain or even sell your idea by
            providing your client with a hands-on experience;</li>
          <li className='text-lg mb-4'><strong className='text-lg'>Communicating your vision</strong>. By using an interactive medium to preview and test
        ...
        <section className="not-format">
          ...
          <article className="p-6 mb-6 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
            <footer className="flex justify-between items-center mb-2">
              <div className="flex items-center">
                <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white"><img className="mr-2 w-6 h-6 rounded-full object-cover" src="./assets/Bonace.jpg" alt="Bonace Patrick" />Bonace Patrick</p>
  ...
  <footer className="bg-gray-50 dark:bg-gray-800">
    <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
      <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
        ...
        <div>
          <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">My services</h2>
          <ul className="text-gray-500 dark:text-gray-400">
            <li className="mb-4">
              <a href="#" className=" hover:underline">Website design</a>
            </li>
            <li className="mb-4">
              <a href="#" className="hover:underline">Mobile app design</a>
            </li>
            <li className="mb-4">
              <a href="#" className="hover:underline">Systems design</a>
            </li>

          </ul>
        </div>
        <div>
          <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Offer & Discount</h2>
          <ul className="text-gray-500 dark:text-gray-400">
            <li className="mb-4">
              <a href="#" className="hover:underline">For Websites</a>
            </li>
            <li className="mb-4">
              <a href="#" className="hover:underline">For Mobile App</a>
            </li>
            <li className="mb-4">
              <a href="#" className="hover:underline">For Systems design</a>
            </li>
      ...
      <div className="text-center">
        ...
        <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Bonace Patrick</a>. All Rights Reserved.
        </span>
