    ...
    <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
      <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        <header className="mb-4 lg:mb-6 not-format">
          ...
          <h1 className="mb-4 text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl dark:text-white">Master how to become a Professional web developer</h1>
        </header>
        ...
        <figure><img className='rounded-xl' src="https://amigainformatics.com/wp-content/uploads/2019/09/Web-mobile-development-banner-06.jpg" alt />
